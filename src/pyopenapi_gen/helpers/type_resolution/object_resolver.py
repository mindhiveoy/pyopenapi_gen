        ...
        if schema.type == "object":
            ...
            if schema.properties:  # Object has its own properties
                if not schema.name:  # Anonymous object with properties
                    ...
                    # logger.debug(f"[ObjectTypeResolver] Named object '{schema.name}' with properties.")
                    ...
                    if schema.name and schema.name in self.all_schemas:
                        ...
                        # else:
                        # logger.debug(
                        #     f"[ObjectTypeResolver] Skipping self-import for {class_name_to_use} from {model_module_path}"
                        # )
