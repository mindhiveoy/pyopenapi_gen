...
class Document:
    ...
    Attributes:
        ...
        content_type (Optional[str]): Format of the document content (e.g., text, markdown, html)
        metadata (Any): Additional document metadata like author, tags, categories
        ...
        status (Optional[str]): Current processing status of the document
