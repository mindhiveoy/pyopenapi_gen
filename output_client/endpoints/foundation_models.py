...
from ..models.create_foundation_model_request import CreateFoundationModelRequest
from ..models.foundation_model import FoundationModel
from ..models.update_foundation_model_request import UpdateFoundationModelRequest
...
class FoundationModelsClient:
    ...
    async def list_foundation_models(
        ...
        Returns:
            List[FoundationModel]: List of foundation models
        ...
        # Parse response into correct return type
        return cast(List[FoundationModel], response.json())
