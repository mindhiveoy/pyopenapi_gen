...
from ..models.agent_history_list_response import AgentHistoryListResponse
from ..models.agent_list_response import AgentListResponse
from ..models.agent_response import AgentResponse
from ..models.agent_update import AgentUpdate
from ..models.json_field_update_input import JsonFieldUpdateInput
...
class AgentsClient:
    ...
    async def restore_agent_revision(
        ...
        # Parse response into correct return type
        return cast(Union[AgentResponse, Dict[str, Any]], response.json())
    ...
    async def list_agent_revisions(
        ...
        # Parse response into correct return type
        return cast(AgentHistoryListResponse, response.json())
    ...
    async def create_agent(
        ...
        Returns:
            Dict[str, Any]: Agent created successfully
