...
from ..models.get_data_source_events_response import GetDataSourceEventsResponse
...
class DatasourcesClient:
    ...
    async def get_data_source_events(
        ...
        return cast(GetDataSourceEventsResponse, response.json())
    ...
    async def get_datasource(
        ...
        Returns:
            Dict[str, Any]: Datasource retrieved successfully
    ...
    async def update_datasource(
        ...
        Returns:
            Dict[str, Any]: Datasource updated successfully
    ...
    async def list_datasources(
        ...
        # Parse response into correct return type
        return cast(DataSourceListResponse, response.json())
    ...
    async def create_datasource(
        ...
        Returns:
            Dict[str, Any]: DataSource created successfully
