...
from ..models.check_tenant_user_email_response import CheckTenantUserEmailResponse
from ..models.create_tenant_user_request import CreateTenantUserRequest
...
class UsersClient:
    ...
    async def check_tenant_user_email(
        ...
        # Parse response into correct return type
        return cast(CheckTenantUserEmailResponse, response.json())
    ...
    async def get_user(
        ...
        # Parse response into correct return type
        return cast(UserResponse, response.json())
    ...
    async def list_users(
        ...
        # Parse response into correct return type
        return cast(UserListResponse, response.json())
