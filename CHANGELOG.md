...
- **parsing**: Honour OpenAPI 3.1 annotation siblings on $ref
  ([`1cce5d0`](https://github.com/mindhiveoy/pyopenapi_gen/commit/1cce5d0e35591484d9b6e3b62893ee70b356b387))

- **parsing**: Resolve nullable $ref to the referenced type in OpenAPI 3.0 and 3.1
  ([`da54456`](https://github.com/mindhiveoy/pyopenapi_gen/commit/da544560b63f4c7834ae26a2ba3f2f71e4aee0ab))

- **types**: Stop nullable references resolving to the wrong type
  ([`f2affaf`](https://github.com/mindhiveoy/pyopenapi_gen/commit/f2affafb57472cc32c7ef706c06c173e7a141403))

### Chores

- **deps**: Fold in all open Dependabot updates and refresh the lock
  ([`6ba1dc8`](https://github.com/mindhiveoy/pyopenapi_gen/commit/6ba1dc86fda0a9acfc022206dc65ff8d62098284))

- **release**: Sync __init__.py version
  ([`a242496`](https://github.com/mindhiveoy/pyopenapi_gen/commit/a24249641ebb9814675f483f841f8d6570bee68a))
...
- **deps**: Consolidate open dependabot updates
  ([`ffb5894`](https://github.com/mindhiveoy/pyopenapi_gen/commit/ffb5894a82546d683b35a621baf87c636ab053ee))

### Chores

- **release**: Sync __init__.py version
  ([`01a4307`](https://github.com/mindhiveoy/pyopenapi_gen/commit/01a430713cbc269c7bf4b0031bdbb3213d540442))
...
- **core**: Stop SSE at [DONE], send multipart bodies correctly, register nested union dataclass
  hooks
  ([`1b52bd2`](https://github.com/mindhiveoy/pyopenapi_gen/commit/1b52bd220553005078829b7e81e67888e83c6ac2))

### Chores

- **release**: Sync __init__.py version
  ([`94d1517`](https://github.com/mindhiveoy/pyopenapi_gen/commit/94d1517de558e316c88baed7a3504b1043d0f275))

### Continuous Integration

- **claude**: Pin a current model for the PR review action
  ([`60dd2bf`](https://github.com/mindhiveoy/pyopenapi_gen/commit/60dd2bf9b13cb96241bbb45881c2e70cf5619806))
