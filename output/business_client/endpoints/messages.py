...
class MessagesClient:
    ...
    async def add_debug_message(
        ...
        Returns:
            AddDebugMessageResponse: Debug messages added successfully
        ...
        return AddDebugMessageResponse(**response.json())
    ...
    async def get_debug_messages(
        ...
        Returns:
            GetDebugMessagesResponse: Debug messages retrieved successfully
        ...
        # Parse response into correct return type
        return GetDebugMessagesResponse(**response.json())
    ...
    async def get_message(
        ...
        Returns:
            GetMessageResponse: Message details
        ...
        # Parse response into correct return type
        return GetMessageResponse(**response.json())
    ...
    async def get_messages(
        ...
        # Parse response into correct return type
        return GetMessagesResponse(**response.json())