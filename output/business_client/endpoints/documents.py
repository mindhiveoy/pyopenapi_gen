...
from typing import Any, AsyncIterator, Callable, Dict, IO, Optional, cast
...
class DocumentsClient:
    ...
    async def get_document(
        ...
        Returns:
            AsyncIterator[Dict[str, Any]]: Returns the document details in JSON format, or the
                                           document file as a downloadable stream if the
                                           "download" query parameter is provided.
    ...
    async def log_document_event(
        ...
        Returns:
            LogDocumentEventResponse: Event logged successfully
        ...
        # Parse response into correct return type
        return LogDocumentEventResponse(**response.json())
    ...
    async def create_document(
        ...
        Returns:
            DocumentResponse: Document created successfully
    ...
    async def clean_document(
        ...
        # Parse response into correct return type
        return CleanDocumentResponse(**response.json())