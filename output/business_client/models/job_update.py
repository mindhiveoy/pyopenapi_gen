...
class JobUpdate:
    ...
    Attributes:
        ...
        type (Optional[JobUpdateTypeEnum]): Type of job
        status (Optional[JobUpdateStatusEnum]): Current status of the job
    ...
    type: Optional[JobUpdateTypeEnum] = None
    status: Optional[JobUpdateStatusEnum] = None
