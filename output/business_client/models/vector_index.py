...
class VectorIndex:
    ...
    Attributes:
        ...
        config (Optional[Any]): Configuration object for the vector index
        dimensions (Optional[int]): Vector dimension size for this index
        status (Optional[VectorIndexStatusEnum]): Status of the vector index
        error (Optional[str]): Error message if the index failed
        description (Optional[str]): Description of the vector index
        metadata (Optional[Any]): Additional metadata about the index
    ...
    status: Optional[VectorIndexStatusEnum] = None
