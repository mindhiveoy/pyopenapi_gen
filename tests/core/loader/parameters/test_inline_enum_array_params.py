...
def test_inline_enum_array_parameter_generation():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert "from ..models.get_agent_param_include_item import GetAgentParamIncludeItem" in endpoint_content, \
            "Endpoint should import the enum type"
        assert "include: Optional[List[GetAgentParamIncludeItem]]" in endpoint_content, \
...
def test_business_swagger_inline_enum_parameters():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            from business_client.endpoints.agents import AgentsClient
