...
from pyopenapi_gen.helpers.endpoint_utils import get_return_type, _infer_type_from_path


def test_infer_type_from_path():
...
def test_get_endpoint_infers_response_type():
...
def test_get_endpoint_with_defined_response_type():
    ...
    operation = IROperation(
        ...
        responses=[
            IRResponse(
                status_code="200",
                description="Success",
                content={"application/json": custom_response_schema}
            )
