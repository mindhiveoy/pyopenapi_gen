...
class TestNamedTypeResolver:
    ...
    def test_named_resolver__resolve_schema_reference__adds_import_returns_class_name(self):
        ...
        # Assert
        assert result == "User"
        self.context.add_import.assert_called_with(
            logical_module="myapi.models.user",
            name="User"
        )
    ...
    def test_named_resolver__resolve_schema_reference_self_reference__returns_quoted_name(self):
        ...
        ref_schema = IRSchema(
            name="TreeNode",
            generation_name="TreeNode",
            final_module_stem="tree_node"
        )
    ...
    def test_named_resolver__resolve_schema_reference_resolve_alias_target_true_simple_alias__returns_none(self):
        ...
        ref_schema = IRSchema(
            name="StringAlias",
            type="string",
            generation_name="StringAlias",
            final_module_stem="string_alias"
        )
    ...
    def test_named_resolver__resolve_schema_reference_resolve_alias_target_true_complex_schema__returns_class_name(self):
        ...
        self.context.add_import.assert_called_with(
            logical_module="myapi.models.data_object",
            name="DataObject"
        )
    ...
    def test_named_resolver__resolve_schema_reference_resolve_alias_target_true_enum_schema__returns_class_name(self):
        ...
        self.context.add_import.assert_called_with(
            logical_module="myapi.models.status_enum",
            name="StatusEnum"
        )
    ...
    def test_named_resolver__resolve_schema_reference_resolve_alias_target_true_any_of_schema__returns_class_name(self):
        ...
        self.context.add_import.assert_called_with(
            logical_module="myapi.models.union_type",
            name="UnionType"
        )
    ...
    def test_named_resolver__resolve_schema_reference_resolve_alias_target_true_one_of_schema__returns_class_name(self):
        ...
        self.context.add_import.assert_called_with(
            logical_module="myapi.models.choice_type",
            name="ChoiceType"
        )
    ...
    def test_named_resolver__resolve_schema_reference_resolve_alias_target_true_all_of_schema__returns_class_name(self):
        ...
        ref_schema = IRSchema(
            ...
            all_of=[IRSchema(type="object"), IRSchema(properties={"field": IRSchema(type="string")})]  # Has allOf - not simple alias
        )
        ...
        self.context.add_import.assert_called_with(
            logical_module="myapi.models.combined_type",
            name="CombinedType"
        )
    ...
    def test_named_resolver__resolve_inline_anonymous_enum_no_type__returns_str_default(self):
        ...
        schema = IRSchema(
            name=None,
            enum=["value1", "value2"]  # No type specified
        )
    ...
    def test_named_resolver__resolve_schema_reference_missing_generation_name__raises_assertion_error(self):
        ...
        ref_schema = IRSchema(
            name="User",
            generation_name=None,  # Missing generation_name
            final_module_stem="user"
        )
        self.all_schemas["User"] = ref_schema
    ...
    def test_named_resolver__resolve_complex_package_path(self):
        ...
        assert result == "User"
        self.context.add_import.assert_called_with(
            logical_module="myorg.services.userapi.models.user",
            name="User"
        )
    ...
    def test_named_resolver__resolve_with_sanitization(self):
        ...
        # Arrange
        schema = IRSchema(
            name="Status-Enum-With-Dashes",  # Needs sanitization
            type="string",
    ...
    def test_named_resolver__edge_case_empty_enum(self):
        ...
        schema = IRSchema(
            name=None,
            type="string",
            enum=[]  # Empty enum - falsy in boolean context
        )
    ...
    def test_named_resolver__resolve_with_none_schema_name_but_has_reference(self):
        ...
        ref_schema = IRSchema(
            name="SomeModel",
            generation_name="SomeModel",
            final_module_stem="some_model"
        )
