...
from pyopenapi_gen import IROperation, IRRequestBody, IRSchema
from pyopenapi_gen.context.render_context import RenderContext
from pyopenapi_gen.helpers.endpoint_utils import get_return_type, _find_resource_schema


def test_find_resource_schema():
...
def test_put_endpoint_with_update_schema_infers_resource_type():
    ...
    operation = IROperation(
        ...
        request_body=IRRequestBody(
            required=True,
            content={
                "application/json": tenant_update_schema
            }
        )
    )
...
def test_put_endpoint_with_no_matching_resource_uses_update_type():
    ...
    operation = IROperation(
        ...
        request_body=IRRequestBody(
            required=True,
            content={
                "application/json": config_update_schema
            }
        )
    )
...
def test_non_put_endpoint_returns_none_without_response():
