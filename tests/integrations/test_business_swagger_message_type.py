...
def test_chatcreate_message_property_type_generation():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        has_correct_type = (
            "message: str" in chat_create_content or 
            "message: Optional[str]" in chat_create_content
        )
        ...
        has_incorrect_type = (
            "message: Message" in chat_create_content or 
            "message: Optional[Message]" in chat_create_content
        )
        assert not has_incorrect_type, (
            f"Found incorrect 'message: Message' type annotation. "
            f"Generated content:\n{chat_create_content}"
        )
