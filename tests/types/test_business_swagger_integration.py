...
class TestBusinessSwaggerIntegration:
    ...
    def test_message_batch_response_type_resolution(self, mock_context) -> None:
        ...
        message_schema = IRSchema(
            name="Message",
            type="object",
            generation_name="Message",
            final_module_stem="message"
        )
        ...
        schemas = {
            ...
            "MessageBatchResponse": message_batch_response_schema
        }
        ...
        response = IRResponse(
            ...
            description="Success",
            content={
                "application/json": message_batch_response_schema
            }
        )
    ...
    def test_message_response_type_resolution(self, mock_context) -> None:
        ...
        response = IRResponse(
            ...
            description="Created",
            content={
                "application/json": message_response_schema
            }
        )
