...
class TestOpenAPIResponseResolver:
    ...
    def test_resolve_operation_response__200_response__returns_resolved_type(self, resolver, mock_context, mock_schema_resolver) -> None:
        """
    ...
    def test_resolve_operation_response__prefers_200_over_201(self, resolver, mock_context, mock_schema_resolver) -> None:
        """
    ...
    def test_resolve_specific_response__with_content__returns_resolved_type(self, resolver, mock_context, mock_schema_resolver) -> None:
        """
    ...
    def test_resolve_specific_response__data_unwrapping__returns_unwrapped_type(self, resolver, mock_context, mock_schema_resolver) -> None:
        """
    ...
    def test_resolve_specific_response__response_reference__resolves_target(self, resolver, mock_context, mock_ref_resolver) -> None:
        """
        ...
        target_response = IRResponse(
            status_code="200",
            description="Success",
            content={"application/json": target_schema}
        )
        response = Mock()
    ...
    def test_resolve_specific_response__prefers_application_json(self, resolver, mock_context, mock_schema_resolver) -> None:
        """
